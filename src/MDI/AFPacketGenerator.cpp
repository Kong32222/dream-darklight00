...
CVector<_BYTE> CAFPacketGenerator::
GenAFPacket(const bool bUseAFCRC, CTagPacketGenerator& TagPacketGenerator)
{
/*
...
// TODO: check if padding bits are needed to get byte alignment!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    vecbiAFPkt.Enqueue((/* unsigned int */uint32_t ) 'A', SIZEOF__BYTE);
