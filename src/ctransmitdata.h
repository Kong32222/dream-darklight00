...
#include "Soundbar/soundbar.h" //DEBUG_

class CTransmitData : public CTransmitterModul<_COMPLEX, _COMPLEX>
{
public:
    enum EOutFormat {
        OF_REAL_VAL /* real valued */, OF_IQ_POS,
    ...
    {
        //当修改内容的时候  确实可以调用到这个函数
        rDefCarOffset = rNewCarOffset;
        // DEBUG_COUT(" "<< rDefCarOffset <<"kHz");
    }
...
protected:
    ...
    std::string		strOutFileName;   //IQ file
    bool			bUseSoundcard;
    int				iSampleRate;
