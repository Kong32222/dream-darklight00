...
void COFDMCellMapping::ProcessDataInternal(CParameter& TransmParam)
{
    ...
    // 查看超帧的符号num
    //  cout<<"iSymbolCounterAbs = "<<TransmParam.iFrameIDTransm * iNumSymPerFrame + iSymbolCounter << endl;
    ...
    //本次单元的个数
//    cout<<"cell iMSCCounter:"<<iMSCCounter<<endl;
//    cout<<"cell iFACCounter:"<<iFACCounter<<endl;
//    cout<<"cell iSDCCounter:"<<iSDCCounter <<endl;
    // cout<<"MSC虚拟单位 iDummyCellCounter :"<< iDummyCellCounter<<endl;   // 0

//下一符号的size
//    cout<<"cell [FAC]OFDM OutputBlockSize:"<<iInputBlockSize2<<endl;
//    cout<<"cell [SDC]OFDM OutputBlockSize:"<<iInputBlockSize3<<endl;
//    cout<<"cell [MSC]OFDM OutputBlockSize:"<<iInputBlockSize <<endl;
}
...
void COFDMCellMapping::InitInternal(CParameter& TransmParam)
{
    ...
    iNumSymPerFrame = Param.iNumSymPerFrame;  // 符号个数
    iNumCarrier = Param.iNumCarrier;          // 每一个符号载波的个数

    /* Init symbol-counter */
    iSymbolCounter = 0;                       // 当前符号

    /* Init frame ID */
    TransmParam.iFrameIDTransm = 0;          //  frame; 0 1 2
    /*
     * 模式A  频谱占用3 打印结果
        --------------------------------------------------
        iNumSymPerFrame = 	15
    ...
    */
    //    cout<<"--------------------------------------------------" <<endl;
    //    cout<<"iNumSymPerFrame = \t"<<iNumSymPerFrame<<endl;
    //    cout<<"iNumCarrier = \t"<<Param.iNumCarrier <<endl;
    //    cout<<"iSymbolCounter = \t"<<iSymbolCounter <<endl;
    //    cout<<"TransmParam.iFrameIDTransm = "<< TransmParam.iFrameIDTransm <<endl;
    //    cout<<"--------------------------------------------------" <<endl;


    // MSC mode: 打印结果 : TransmParam.eMSCCodingScheme = 1(CS_2_SM: 16QAM )
    cout<<"TransmParam.eMSCCodingScheme = "<< TransmParam.eMSCCodingScheme <<endl;
    ...
    */
    cout<<"MSC size[0] = "<< iInputBlockSize <<endl;
    cout<<"FAC size[0] = "<< iInputBlockSize2 <<endl;
    cout<<"SDC size[0] = "<< iInputBlockSize3 <<endl;
...
void COFDMCellDemapping::ProcessDataInternal(CParameter& Parameters)
{
    ...
    //    cout<<"[MSC]OFDM iOutputBlockSize:"<<iOutputBlockSize <<endl;
    //    cout<<"[FAC]OFDM iOutputBlockSize:"<<iOutputBlockSize2<<endl;
    //    cout<<"[SDC]OFDM iOutputBlockSize:"<<iOutputBlockSize3<<endl;
