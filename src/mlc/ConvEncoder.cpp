...
{
    /* Number of bits out is the sum of all protection levels 输出的比特数是所有保护级别的总和 */
    iNumInBits = iNewNumInBitsPartA + iNewNumInBitsPartB;

//    std::cout<<"iNewNumInBitsPartA + iNewNumInBitsPartB =iNumInBits = "<<iNumInBits
//            <<std::endl;

    /* Number of out bits including the state memory 输出位数，包括状态存储器 */
