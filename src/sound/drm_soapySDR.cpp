...
// Constructor(s)
CSoapySDRIn::CSoapySDRIn() : currentDev(""),
    iSampleRate(96000), iBufferSize(0),
    iFrequency(iLastTunedFrequency), pDevice(nullptr), pStream(nullptr)
{
...
void CSoapySDRIn::Enumerate(std::vector<std::string>& names,
                            std::vector<std::string>& descriptions,
                            std::string& defaultDevice)
{
    ...
    names.clear();
    std::cout<<"SDR Device.size = "<<results.size() <<std::endl;
